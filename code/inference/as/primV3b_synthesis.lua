...
function a_b_s(model, id, iterations, verbose)
	...
	local path = '/data/vision/billf/object-properties/sound/sound/primitives/exp/primV3b/'
...
pretrainedModel = '/data/vision/billf/object-properties/sound/sound/primitives/models/primV3b_cnnF_soundnet8_pretrainnone_mse1_LR0.001/model_93.t7'
id = tonumber(arg[1])

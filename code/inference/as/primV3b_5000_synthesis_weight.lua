...
function a_b_s(model, id, iterations, verbose)
	...
	local path = '/data/vision/billf/object-properties/sound/sound/primitives/exp/primV3b_5000_weight/'
	...
	local weights_file = io.open(scripts .. 'visualize/primV3b_5000_weights.txt','r')

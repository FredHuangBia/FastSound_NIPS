...
function a_b_s(model, id, iterations, verbose)
	...
	local path = '/data/vision/billf/object-properties/sound/sound/primitives/exp/primV3b_raw_recog/'
	...
	local ll = log_likelihood(init_sound_raw, real_sound_raw)
	...
	for i = 1, iterations do
		...
		for j = 1, #params do
			...
			local new_ll = log_likelihood(new_sound_raw,real_sound_raw)
			if new_ll < ll then

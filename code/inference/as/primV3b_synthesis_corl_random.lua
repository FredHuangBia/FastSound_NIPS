...
function a_b_s(model, id, iterations, verbose)
	...
	local path = '/data/vision/billf/object-properties/sound/sound/primitives/exp/primV3b_corl_random/'
	...
	local autocorrelation = get_correlation(real_sound_t7,real_sound_t7)
	...
	local crosscorrelation = get_correlation(real_sound_t7,init_sound_t7)
	...
	for i = 1, iterations do
		...
		for j = 1, #params do
			...
			local new_correlation = get_correlation(real_sound_t7,new_sound_t7)

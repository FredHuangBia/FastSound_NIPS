...
model = '/data/vision/billf/object-properties/sound/sound/primitives/models/primV3b_5000_cnnF_soundnet8_pretrainnone_mse1_LR0.001/model_50.t7'
...
fout = io.open("primV3b_5000_weights.txt","w")
for i = 1,1024 do
	fout:write(max[i]..'\n')
end
fout:close()

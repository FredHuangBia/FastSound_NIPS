...
def main():
	...
	targets_file = '/data/vision/billf/object-properties/sound/sound/primitives/www/primV2e_cnnE_soundnet8_pretrainnone_mse1_LR0.001/131/targets.txt'
	targets = get_targets(targets_file)
	# targets = ['000280','101824']
	ground_truth_file = '/data/vision/billf/object-properties/sound/sound/primitives/data/primV2e.txt'

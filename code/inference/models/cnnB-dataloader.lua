...
local M = {}
local DataLoader = torch.class('cnnB.DataLoader', M)
...
function DataLoader.create(opt)
  ...
  for i, split in ipairs{'train', 'val'} do
    local dataset = datasets.create(opt, split)   -- call function in init.lua, get primV2d class, which is defined in primV2d.lua
    ...
    while idx <= size and threads:acceptsjob() do
      ...
      function(indices)
        ...
        for i, idx in ipairs(indices:totable()) do
          ...
          ID[1] = sample.xml[6] -- corresponding id 

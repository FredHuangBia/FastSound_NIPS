...
function get_feature(net_input)
...
function a_b_s(model, id, iterations, verbose)
	...
	local path = '/data/vision/billf/object-properties/sound/sound/primitives/exp/primV3b_stft_recog/'
...
-- ourmodel = torch.load(pretrainedModel)
-- print(ourmodel)
-- id = tonumber(arg[1])

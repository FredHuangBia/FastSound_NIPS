...
local M = {}
local PrimV2dDataset = torch.class('PrimV2dDataset', M)

function PrimV2dDataset:__init(dataInfo, opt, split)
...
-- function PrimV2dDataset:get(i, loadAudio)

function PrimV2dDataset:get(i, loadAudio) -- return audio xml xmlLen
...
function PrimV2dDataset:size()
  return self.dataInfo.dataPath:size(1)
end


function PrimV2dDataset:preprocessAudio()
...
function PrimV2dDataset:postprocessAudio()
  return t.Compose{
    PrimV2dDataset.wavView(),
    t.AudioUnnormalize(),
  }
end

function PrimV2dDataset:soundnetView()
  return function(input)
    return input:view(1, -1, 1)
  end
end

function PrimV2dDataset:wavView()
  return function(input)
...
function PrimV2dDataset:preprocessXml()
  return function(input)
...
function PrimV2dDataset:postprocessXml()
  return function(input)

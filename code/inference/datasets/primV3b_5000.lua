...
local M = {}
local PrimV3b_5000Dataset = torch.class('PrimV3b_5000Dataset', M)

function PrimV3b_5000Dataset:__init(dataInfo, opt, split)
...
-- function PrimV3b_5000Dataset:get(i, loadAudio)

function PrimV3b_5000Dataset:get(i, loadAudio) -- return audio xml xmlLen
...
function PrimV3b_5000Dataset:size()
  return self.dataInfo.dataPath:size(1)
end


function PrimV3b_5000Dataset:preprocessAudio()
  if self.split == 'train' then
    return t.Compose{
      ...
      t.AmpNormalize(2),
      PrimV3b_5000Dataset.soundnetView(),
    }
...
function PrimV3b_5000Dataset:postprocessAudio()
  return t.Compose{
    PrimV3b_5000Dataset.wavView(),
    t.AudioUnnormalize(),
  }
end

function PrimV3b_5000Dataset:soundnetView()
  return function(input)
    return input:view(1, -1, 1)
  end
end

function PrimV3b_5000Dataset:wavView()
  return function(input)
...
function PrimV3b_5000Dataset:preprocessXml()
  return function(input)
...
function PrimV3b_5000Dataset:postprocessXml()
  return function(input)
    if self.opt.netType == 'cnnF' then

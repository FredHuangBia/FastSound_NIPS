...
test = '/data/vision/billf/object-properties/sound/sound/primitives/exp/self_sup_v2/test_sound/'
exp = '/data/vision/billf/object-properties/sound/sound/primitives/exp/self_sup_v2/result/'
...
def main():
	...
	parser.add_argument('-e', '--end_id', type=int, help='ending test case', default=49)
	...
	for i in range(len(gt_labels)):
		...
		init_mse.append(MSE(gt_labels[i][:7], init_labels[i], kind))
		final_mse.append(MSE(gt_labels[i][:7], as_labels[i], kind))

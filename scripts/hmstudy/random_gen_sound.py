...
def main():
	...
	data_label = open(ROOT+'../%03d-%03d.txt' %(start, end),'w')
	data_value = open(ROOT+'../%03d-%03d.dat' %(start, end),'w')
	for i in range(start, end+1):
		output_dir = os.path.join(ROOT, '%03d' %i)

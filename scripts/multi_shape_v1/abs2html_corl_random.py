...
ROOT = '/data/vision/billf/object-properties/sound/sound/primitives/exp/primV3b_corl_random/'
...
fileOut = open(ROOT+'synth_raw_random-%02d.txt'%(split),'w')

for line in fileIn:
	line = line.split()
	cmd = 'th /data/vision/billf/object-properties/sound/sound/primitives/code/inference/as/primV3b_synthesis_corl_random.lua %s 30' %(line[0])
	print(cmd)

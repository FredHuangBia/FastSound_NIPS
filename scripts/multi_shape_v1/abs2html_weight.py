...
ROOT = '/data/vision/billf/object-properties/sound/sound/primitives/exp/primV3b_weight/'
...
fileOut = open(ROOT+'synth_weight-%02d.txt'%(split),'w')

for line in fileIn:
	line = line.split()
	cmd = 'CUDA_VISIBLE_DEVICES=%s th /data/vision/billf/object-properties/sound/sound/primitives/code/inference/as/primV3b_synthesis_weight.lua %s 30' %(gpu,line[0])
	print(cmd)

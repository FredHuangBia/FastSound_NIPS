...
ROOT = '/data/vision/billf/object-properties/sound/sound/primitives/exp/primV3b_raw_random/'
...
for line in fileIn:
	line = line.split()
	cmd = 'th /data/vision/billf/object-properties/sound/sound/primitives/code/inference/as/primV3b_synthesis_raw_random.lua %s 30' %(line[0])
	print(cmd)

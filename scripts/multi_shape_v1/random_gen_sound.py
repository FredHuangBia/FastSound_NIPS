...
ROOT = '/data/vision/billf/object-properties/sound/sound/primitives/data/primV3b/'
scripts = '/data/vision/billf/object-properties/sound/sound/primitives/scripts/multi_shape_v1/'
...
def main():
	...
	data_label = open(ROOT+'../labels3b/%06d-%06d.txt' %(start, end),'w')
	data_value = open(ROOT+'../labels3b/%06d-%06d.dat' %(start, end),'w')
	parent_dir = math.floor(start/1000)+1
	for i in range(start, end+1):
		output_dir = os.path.join(ROOT, '%03d' %parent_dir, '%06d' %i)

'''
	generate all materials config, only with youngs modulus changing
	usage: python gen_test_materials.py
'''
...
ROOT = '/data/vision/billf/object-properties/sound/sound/primitives/data/v4s/'
...
def Youngs():
	...
	for counter, value in enumerate(E):
		fileOut = open('material-%d.cfg' %counter, 'w')
		fileOut.writelines(template(value/10,nu0,rho0,alpha0,beta0))

...
SOURCEPATH=/data/vision/billf/object-properties/sound/sound/primitives/scripts/BEM_PL_v4
LIBPATH=/data/vision/billf/object-properties/sound/software/fmmlib3d-1.2/matlab
CURPATH=/data/vision/billf/object-properties/sound/sound/primitives/data/v4s/BEMs/$1$2
...
kinit -R
python /data/vision/billf/object-properties/sound/sound/primitives/scripts/BEM_PL_v4/pre_calc_ev.py $1 $2 0 $HOSTNAME

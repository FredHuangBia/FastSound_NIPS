...
def main():
	prim = [414] # random.seed(13)
	# prim = None
	split = int(sys.argv[1])
	debug_list = open('/data/vision/billf/object-properties/sound/sound/primitives/data/labels2e/debug/missing-%02d.txt'%split,'r')
	data_label = open(ROOT+'../labels2e/debug-%02d.txt' %split,'w')
	data_value = open(ROOT+'../labels2e/debug-%02d.dat' %split,'w')
	for i in debug_list:
		i = int(i.strip())

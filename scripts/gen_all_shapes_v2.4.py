...
def twosym():
	listofxy = [x*1/10 for x in range(1,7)]
	listofz = [x*1/10 for x in range(1,7)]
...
def onesym():
	listofx = [x*1/10 for x in range(1,6)]
	listofy = [x*1/10 for x in range(1,6)]
	listofz = [x*1/10 for x in range(1,6)]
	output = []
	for i in listofx:
		for j in listofy:
			for k in listofz:
